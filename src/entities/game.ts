/**
 * In-game domain models — the character, the scenario, and the public
 * reveal state. Mirror of the bunker-api game DTOs (inner payload).
 */
import type { ParticipantStatus, RoomStatus } from './room';
